...
به دلیل علاقه‌مندی به حوزه هوش مصنوعی و تغییر مسیرم، این مخزن را آرشیو کردم.  
اگر واقعاً تمایل به توسعه این مخزن دارید، می‌توانید از طریق [ایمیل](mailto:itsnazarkhani@gmail.com) با من در تماس باشید.
